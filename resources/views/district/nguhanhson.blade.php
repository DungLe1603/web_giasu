    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-6">
          <div class="page-title"><h1>Gia sư dạy kèm tại quận Ngũ Hành Sơn</h1></div>
        </div>
      </div>
    </div>  
  </div>
